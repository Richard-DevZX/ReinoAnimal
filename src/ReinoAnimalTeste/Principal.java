...
public class Principal {
	...
	public static void main(String[] args) {
		...
		Aquatico aqua1 = new Aquatico("Rhincodon typus", "fêmea", 3, "água salgada", false);
		
		Aquatico aqua2 = new Aquatico("Pseudocrocidolita", "macho", 1, "água doce", true);
		...
		Aereo air1 = new Aereo("Trochilus", "macho", 1, 40.5);
		
		Aereo air2 = new Aereo("Cyanopsitta spixii", "fêmea", 7, 50.9);
